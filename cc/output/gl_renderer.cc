...
GLRenderer::GLRenderer(RendererClient* client,
  ...
  ZEROCOPY_LOG_PARTIAL_SWAP("partial_swap_enabled = %s   post_sub_buffer = %s",
    settings_->partial_swap_enabled? "yes":"no",
    context_caps.gpu.post_sub_buffer? "yes":"no");
  capabilities_.using_partial_swap = context_caps.gpu.post_sub_buffer;
#else
  ...
  capabilities_.use_tiled_rendering = context_caps.gpu.use_tiled_rendering;
#endif
