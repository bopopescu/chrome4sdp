...
def CombineZipResources(resource_dirs, zip_path):
  ...
  for i, d in enumerate(resource_dirs):
    zip_out_path = os.path.splitext(zip_path)[0] + str(i) + ".zip"
...
#SWE-feature-overlay
    if options.resource_extra_dirs:
      input_resource_extra_dirs = build_utils.ParseGypList(options.resource_extra_dirs)
