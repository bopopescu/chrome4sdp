    ...
    'variables': {
      'variables': {
        ...
        'conditions': [
          ...
          ['OS=="android"', {
            'branding_path_component%': '<!pymod_do_main(swe_channels_dirs --swe-channels <(swe_channels) \
                                        -d <(DEPTH) --branding-name)',
          }],
        ...
        'variables': {
          'variables': {
            ...
            'conditions': [
              ...
              ['component=="shared_library" or asan==1 or swe_component=="shared_library"', {
                ...
                'conditions': [
                  ...
                  ['OS=="android"', {
                    ...
                    'conditions': [
                      ...
                      ['clang==1 and clang_use_snapdragon==1 and clang_use_lto==1', {
                        'ldflags': [
                          '-flto -mcpu=cortex-a9',
                        ],
                      }],
