...
bool IsGpuMemoryBufferFactoryConfigurationSupported(
  ...
  switch (type) {
    ...
    case gfx::TEXTURE_MEMORY_BUFFER:
      ZEROCOPY_LOG("IsGpuMemoryBufferFactoryConfigurationSupported    TEXTURE_MEMORY_BUFFER");
      return GpuMemoryBufferFactoryTextureMemory::
          IsGpuMemoryBufferConfigurationSupported(configuration.format,
                                                  configuration.usage);
#endif
#if defined(USE_OZONE)
...
#ifdef DO_ZERO_COPY
  ZEROCOPY_LOG("BrowserGpuMemoryBufferManager::AllocateGpuMemoryBufferForChildProcess");
#endif
...
void BrowserGpuMemoryBufferManager::AllocateGpuMemoryBufferOnIO(
  ...
  DCHECK_CURRENTLY_ON(BrowserThread::IO);
#ifdef DO_ZERO_COPY
  ZEROCOPY_LOG("BrowserGpuMemoryBufferManager::AllocateGpuMemoryBufferOnIO");
#endif
