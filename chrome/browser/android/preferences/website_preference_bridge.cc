    ...
    switch (content_type) {
      ...
      case CONTENT_SETTINGS_TYPE_FULLSCREEN:
        Java_WebsitePreferenceBridge_insertFullscreenInfoIntoList(
            env, list, jorigin.obj(), jembedder.obj());
        break;
      case CONTENT_SETTINGS_TYPE_WEBREFINER:
        Java_WebsitePreferenceBridge_insertWebRefinerInfoIntoList(
            env, list, jorigin.obj(), jembedder.obj());
        break;
      case CONTENT_SETTINGS_TYPE_WEBDEFENDER:
...
static void GetWebRefinerOrigins(JNIEnv* env,
                                 ...
                                 jobject list,
                                 jboolean managedOnly) {
  GetOrigins(env, CONTENT_SETTINGS_TYPE_WEBREFINER, list, managedOnly);
}
...
static void SetWebRefinerSettingForOrigin(JNIEnv* env,
                                          ...
                                          jint value,
                                          jboolean is_incognito) {
  SetSettingForOrigin(env, CONTENT_SETTINGS_TYPE_WEBREFINER, origin,
...
static void GetWebDefenderOrigins(JNIEnv* env,
                                 ...
                                 jobject list,
                                 jboolean managedOnly) {
  GetOrigins(env, CONTENT_SETTINGS_TYPE_WEBDEFENDER, list, managedOnly);
}
...
static void SetWebDefenderSettingForOrigin(JNIEnv* env,
                                          ...
                                          jint value,
                                          jboolean is_incognito) {
  SetSettingForOrigin(env, CONTENT_SETTINGS_TYPE_WEBDEFENDER, origin,
                      ContentSettingsPattern::Wildcard(),
                      value, is_incognito);
}
