...
//SWE-feature-chrome-driver
    //SWE Browser prefixes socket_name_ with "webview" to ensure it works with
    //Chromedriver. In case of SWE always try fallback option which is expected
