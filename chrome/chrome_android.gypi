  ...
  'targets': [
    ...
    },
    {
      ...
      'variables': {
        ...
        'version_path': '<(DEPTH)/swe/VERSION',
        ...
        'swe_branding_path' : '<!pymod_do_main(swe_channels_dirs --swe-channels <(swe_channels) \
                              -d <(DEPTH) --branding-folder)',

        'conditions': [
          ['branding == "Chrome"', {
            'branding_path': 'app/theme/google_chrome/BRANDING',
          }, {
            'branding_path': '<(swe_branding_path)/BRANDING',
          }],
        ],
      },
