...
deps = {
  ...
  'src/third_party/boringssl/src':
    (Var("chromium_git")) + '/boringssl.git@a7a4063c10a3b92dee3fd91787757de5cf4dd127',
  ...
  'src/third_party/libsweadrenoext':
   Var('webtech_devx_url') + '/libsweadrenoext.git' + '@' + 'f5e357d2a3d585a5b0fa6ef3c70b4e3d01772c66',
  'src/third_party/hunspell_dictionaries':
    (Var("chromium_git")) + '/chromium/deps/hunspell_dictionaries.git@c106afdcec5d3de2622e19f1b3294c47bbd8bd72',
  'src/third_party/icu':
    (Var("chromium_git")) + '/chromium/deps/icu.git@33335bc1ba3e6ab5b87aa36c6524b121218841e3',
  ...
  'src/third_party/libvpx':
    (Var("chromium_git")) + '/chromium/deps/libvpx.git@dfa474a2a20492fff67da75727c4de3936654051',
  ...
  'src/third_party/pdfium':
    (Var("chromium_git")) + '/pdfium.git@72a40ab98c3ade8f362bba7d7d80783058319e6d',
  ...
  'src/third_party/skia':
    (Var("webtech_devx_url")) + '/skia.git@007cb406d4e15e3d4f887c8e44c296321169bc9b',
  ...
  'src/tools/gyp':
    (Var("chromium_git")) + '/external/gyp.git@e32b9adf5ab20a7ac9df510b3845d1a2bd61a922',
  'src/tools/page_cycler/acid3':
    (Var("chromium_git")) + '/chromium/deps/acid3.git@6be0a66a1ebd7ebc5abc1b2f405a945f6d871521',
  'src/tools/swarming_client':
    (Var("chromium_git")) + '/external/swarming.client.git@2866a22530cb65feae5d9f64c83636aed5391d06',
  'src/v8':
    (Var('webtech_devx_url')) + '/v8.git@993fa9d76e62607f4a76f8faaee8417f9adc53e5',
  'src/swe/swe_core':
    (Var('webtech_devx_url')) + '/swe-core.git@25dd03c56762d43652d9e61831b25d226c222af7',
  'src/components/web_refiner':
    (Var('webtech_devx_url')) + '/web-refiner.git' + '@' + '837ee6adc87e28767286d2b38546e34ba46f7ab3',
...
deps_os = {
  'android': {
    ...
    'src/third_party/jarjar':
      (Var("chromium_git")) + '/chromium/deps/jarjar.git@befc8e4ac7cdc715802cd383041ba0311ad8ea21',
  ...
  'win': {
    ...
    'src/third_party/deqp/src':
      (Var("chromium_git")) + '/platform/external/deqp@194294e69d44eac48bc1fb063bd607189650aa5e',
...
hooks = [
  ...
  {
    # Update swe/VERSION.
    'action': ['python', 'src/swe/tools/swe_version.py',
               '-i', 'src/chrome/VERSION',
               '-o', 'src/swe/VERSION'],
    'pattern':
         '.',
    'name':
  ...
  {
    'pattern': '.',
    'action': ['python', 'src/build/libsweadrenoext_init.py'],
  },
  {
    'action': [
  ...
  },
  {
    'action': [
      'python',
      'src/build/web_refiner_init.py'
    ],
    'pattern':
      '.',
    'name':
      'configure_web_refiner',
  },
  {
    'action': [
      'python',
