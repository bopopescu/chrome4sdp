...
WebsiteSettingsRegistry::WebsiteSettingsRegistry() {
  ...
  RegisterContentSetting(CONTENT_SETTINGS_TYPE_WEBREFINER,
                          "webrefiner", CONTENT_SETTING_ALLOW,
                          WebsiteSettingsInfo::UNSYNCABLE);

  RegisterContentSetting(CONTENT_SETTINGS_TYPE_WEBDEFENDER,
                          "webdefender", CONTENT_SETTING_ALLOW,
                          WebsiteSettingsInfo::UNSYNCABLE);
