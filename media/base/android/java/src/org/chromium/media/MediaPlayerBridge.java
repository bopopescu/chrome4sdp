...
public class MediaPlayerBridge {
    ...
    private static final int mPerflockResources[] = { 0x3DFF, 0x2704, 0x2BF5, 0x2C07, 0x2F5A };
    ...
    protected void release() {
        ...
        if (mPerflockAcquired) {
            mPerflockController.releasePerfLock();
            mPerflockAcquired = false;
        }
        mPerflockController = null;
    }
    ...
    protected void start() {
        ...
        if (mPerflockController == null) {
            mPerflockController = new PerflockController(getDuration(), mPerflockResources);
        }
        if (mPerflockController != null && !mPerflockAcquired) {
            mPerflockController.acquirePerfLock();
            mPerflockAcquired = true;
        }
    }
