...
class ChromeBackendSettings(AndroidBrowserBackendSettings):
  ...
  def __init__(self, package, cmdline_file=None,
               activity='com.google.android.apps.chrome.Main',
               pseudo_exec_name='chrome', supports_tab_control=True):
    super(ChromeBackendSettings, self).__init__(
        activity=activity,
        cmdline_file=cmdline_file,
        package=package,
        pseudo_exec_name=pseudo_exec_name,
...
class SweChromeBackendSettings(WebviewBackendSettings):
