    ...
    , m_className(SVGAnimatedString::create(this, HTMLNames::classAttr, SVGString::create()))
{
    ...
    // Delay inserted between frames, in milliseconds
    const int HEAVY_SVG_FRAME_SLACK = 50;
    ...
    if (document.getSvgCounter() < HEAVY_SVG_THRESHOLD) {
        ...
        if (HEAVY_SVG_THRESHOLD == document.getSvgCounter()) {
            ...
            document.heavyRenderingDetected(HEAVY_SVG_DURATION,
                HEAVY_SVG_FRAME_SLACK);
        }
    }
